...
void MeshColor::RenderMeshColorLines()
{
	glBindVertexArray(VAO);

	//Guardar el modo actual de polígono
	GLint polygonMode[2];
	...
	//Cambiar a modo líneas para dibujar solo los bordes
	glPolygonMode(GL_FRONT_AND_BACK, GL_LINE);

	//Dibujar los triángulos como líneas
	glDrawArrays(GL_TRIANGLES, 0, vertexCount);

	//Restaurar el modo anterior (relleno)
