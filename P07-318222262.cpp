...
int main()
{
	...
	while (!mainWindow.getShouldClose())
	{
		...
		modelHeliBase = glm::scale(modelHeliBase, glm::vec3(0.3f, 0.3f, 0.3f));
		...
		spotLights[3].SetFlash(heliPad, glm::normalize(heliDir));
